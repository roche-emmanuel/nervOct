...
public:
  ...
  inline unsigned int nl() const
  {
    return _nl;
  }
  inline unsigned int nt() const
  {
    return _nt;
  }
  ...
  inline value_type *X_train() const
  {
    return _X_train;
  }
  inline unsigned int X_train_size() const
  {
    return _nx;
  }

  inline value_type *y_train() const
  {
    return _y_train;
  }
  inline unsigned int y_train_size() const
  {
    return _ny;
  }

  inline value_type *X_cv() const
  {
    return _X_cv;
  }
  inline unsigned int X_cv_size() const
  {
    return _nx_cv;
  }

  inline value_type *y_cv() const
  {
    return _y_cv;
  }
  inline unsigned int y_cv_size() const
  {
    return _ny_cv;
  }

  inline value_type *params() const
  {
    return _params;
  }
  inline unsigned int np() const
  {
    return _np;
  }

  inline TrainingSet &lambda(value_type val)
  {
    _lambda = val;
    return *this;
  }
  inline value_type lambda() const
  {
    return _lambda;
  }

  inline TrainingSet &maxiter(int val)
  {
    _maxiter = val;
    return *this;
  }
