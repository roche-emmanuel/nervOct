...
void _gd_errfunc_cpu(unsigned int nl, unsigned int* lsizes, unsigned int nsamples, 
...
void gd_errfunc_cpu(unsigned int nl, unsigned int* lsizes, unsigned int nsamples, 
	...
	double* activation, unsigned int ninputs, double* inputs, double& J, double* gradients, double* deltas)
{
	_gd_errfunc_cpu(nl,lsizes,nsamples,params, X, yy, lambda, activation, ninputs, inputs, J, gradients, deltas);
}
