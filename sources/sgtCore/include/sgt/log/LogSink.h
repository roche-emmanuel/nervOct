...
*/
class SGTCORE_EXPORT LogSink : public sgt::Referenced {
    public:
    ...
    */
    virtual void output(int level, const std::string& trace, const std::string& msg) = 0;
    ...
    */
    virtual void process(int level, const std::string& trace, const std::string& msg);
