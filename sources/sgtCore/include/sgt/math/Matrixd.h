...
class Matrixf;
class Matrixd;
std::ostream& operator<<(std::ostream& os, const Matrixd& mat);

class SGTCORE_EXPORT Matrixd
{
    public:
...
class RefMatrixd : public Object, public Matrixd
{
    public:
        ...
        RefMatrixd( const RefMatrixd& other) : Matrixd(other) {}
...
inline Vec3f Matrixd::postMult( const Vec3f& v ) const
{
    ...
    return Vec3f( (Vec3f::value_type)((_mat[0][0]*v.x() + _mat[0][1]*v.y() + _mat[0][2]*v.z() + _mat[0][3])*d),
        (Vec3f::value_type)((_mat[1][0]*v.x() + _mat[1][1]*v.y() + _mat[1][2]*v.z() + _mat[1][3])*d),
        (Vec3f::value_type)((_mat[2][0]*v.x() + _mat[2][1]*v.y() + _mat[2][2]*v.z() + _mat[2][3])*d)) ;
}
...
inline Vec3f Matrixd::preMult( const Vec3f& v ) const
{
    ...
    return Vec3f( (Vec3f::value_type)((_mat[0][0]*v.x() + _mat[1][0]*v.y() + _mat[2][0]*v.z() + _mat[3][0])*d),
        (Vec3f::value_type)((_mat[0][1]*v.x() + _mat[1][1]*v.y() + _mat[2][1]*v.z() + _mat[3][1])*d),
        (Vec3f::value_type)((_mat[0][2]*v.x() + _mat[1][2]*v.y() + _mat[2][2]*v.z() + _mat[3][2])*d));
}
...
{
    return Vec4f( (Vec3f::value_type)(_mat[0][0]*v.x() + _mat[0][1]*v.y() + _mat[0][2]*v.z() + _mat[0][3]*v.w()),
        (Vec3f::value_type)(_mat[1][0]*v.x() + _mat[1][1]*v.y() + _mat[1][2]*v.z() + _mat[1][3]*v.w()),
        (Vec3f::value_type)(_mat[2][0]*v.x() + _mat[2][1]*v.y() + _mat[2][2]*v.z() + _mat[2][3]*v.w()),
        (Vec3f::value_type)(_mat[3][0]*v.x() + _mat[3][1]*v.y() + _mat[3][2]*v.z() + _mat[3][3]*v.w())) ;
}
...
{
    return Vec4f( (Vec3f::value_type)(_mat[0][0]*v.x() + _mat[1][0]*v.y() + _mat[2][0]*v.z() + _mat[3][0]*v.w()),
        (Vec3f::value_type)(_mat[0][1]*v.x() + _mat[1][1]*v.y() + _mat[2][1]*v.z() + _mat[3][1]*v.w()),
        (Vec3f::value_type)(_mat[0][2]*v.x() + _mat[1][2]*v.y() + _mat[2][2]*v.z() + _mat[3][2]*v.w()),
        (Vec3f::value_type)(_mat[0][3]*v.x() + _mat[1][3]*v.y() + _mat[2][3]*v.z() + _mat[3][3]*v.w()));
}
...
{
    return Vec3f( (Vec3f::value_type)(m._mat[0][0]*v.x() + m._mat[1][0]*v.y() + m._mat[2][0]*v.z()),
                 (Vec3f::value_type)(m._mat[0][1]*v.x() + m._mat[1][1]*v.y() + m._mat[2][1]*v.z()),
                 (Vec3f::value_type)(m._mat[0][2]*v.x() + m._mat[1][2]*v.y() + m._mat[2][2]*v.z()));
}
...
{
    return Vec3f( (Vec3f::value_type)(m._mat[0][0]*v.x() + m._mat[0][1]*v.y() + m._mat[0][2]*v.z()),
                 (Vec3f::value_type)(m._mat[1][0]*v.x() + m._mat[1][1]*v.y() + m._mat[1][2]*v.z()),
                 (Vec3f::value_type)(m._mat[2][0]*v.x() + m._mat[2][1]*v.y() + m._mat[2][2]*v.z()) ) ;
}
...
inline std::ostream& operator<<(std::ostream& os, const Matrixd& mat)
{
    os << "Matrixd(\n";
