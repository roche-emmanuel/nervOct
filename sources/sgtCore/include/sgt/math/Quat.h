...
class Quat;
std::ostream& operator<<(std::ostream& os, const Quat& val);

/** A quaternion class. It can be used to represent an orientation in 3D space.*/
class SGTCORE_EXPORT Quat
{
    ...
    public:
        ...
        inline void set(const sgt::Vec4f& v)
        {
            _v[0]=v.x();
            _v[1]=v.y();
            _v[2]=v.z();
        ...
        inline void set(const sgt::Vec4d& v)
        {
            _v[0]=v.x();
            _v[1]=v.y();
            _v[2]=v.z();
...
inline std::ostream& operator<<(std::ostream& os, const Quat& val)
{
    os << "Quat("<<val.x()<<", "<<val.y()<<", "<<val.z()<<", "<<val.w()<<")";
    return os;
}
