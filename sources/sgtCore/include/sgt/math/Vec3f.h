...
#include <sgt/math/Vec2f.h>
#include <sgt/math/helpers.h>
...
class Vec3f
{
    public:
        ...
        inline bool isNaN() const { return sgt::isNaN(_v[0]) || sgt::isNaN(_v[1]) || sgt::isNaN(_v[2]); }
...
inline std::ostream& operator<<(std::ostream& os, const Vec3f& val)
{
