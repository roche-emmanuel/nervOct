...
#include <sgt/math/Matrixf.h>
#include <sgt/math/Matrixd.h>
...
void Quat::makeRotate_original( const Vec3d& from, const Vec3d& to )
{
    ...
    {
        logINFO("*** Quat::makeRotate(from,to) with near co-linear vectors, epsilon= "<<fabs(cosangle-1));
...
void test_Quat_Eueler(value_type heading,value_type pitch,value_type roll)
{
    ...
    sgt::Vec3 xAxis(1,0,0);
    sgt::Vec3 yAxis(0,1,0);
    sgt::Vec3 zAxis(0,0,1);
    ...
    sgt::Matrix r_m = sgt::Matrix::rotate(roll,0.0,1.0,0.0)*
                      sgt::Matrix::rotate(pitch,1.0,0.0,0.0)*
                      sgt::Matrix::rotate(-heading,0.0,0.0,1.0);
...
void test_Quat()
{
    ...
    test_Quat_Eueler(sgt::DegreesToRadians(20),0,0);
    test_Quat_Eueler(0,sgt::DegreesToRadians(20),0);
    test_Quat_Eueler(0,0,sgt::DegreesToRadians(20));
    test_Quat_Eueler(sgt::DegreesToRadians(20),sgt::DegreesToRadians(20),sgt::DegreesToRadians(20));
    return 0;
}
#endif
