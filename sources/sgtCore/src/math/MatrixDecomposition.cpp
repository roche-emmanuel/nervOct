...
*/
//sgtManipulator - Copyright (C) 2007 Fugro-Jason B.V.
...
namespace MatrixDecomposition
{
    ...
    typedef struct
    {
        sgt::Vec4d t;     // Translation Component;
    ...
    void decompAffine(_HMatrix A, _affineParts * parts)
        {
            ...
            parts->t = sgt::Vec4d(A[X][W], A[Y][W], A[Z][W], 0);
...
void sgt::Matrixf::decompose(sgt::Vec3f& t,
                             sgt::Quat& r,
                             sgt::Vec3f& s,
                             sgt::Quat& so) const
{
...
void sgt::Matrixf::decompose(sgt::Vec3d& t,
                             sgt::Quat& r,
                             sgt::Vec3d& s,
                             sgt::Quat& so) const
{
...
void sgt::Matrixd::decompose(sgt::Vec3f& t,
                             sgt::Quat& r,
                             sgt::Vec3f& s,
                             sgt::Quat& so) const
{
...
void sgt::Matrixd::decompose(sgt::Vec3d& t,
                             sgt::Quat& r,
                             sgt::Vec3d& s,
                             sgt::Quat& so) const
{
